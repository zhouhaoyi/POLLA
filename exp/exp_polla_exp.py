...
from models.modelexp import POLLA_gcn, POLLA_diff, POLLA_adpadj, POLLA_adpadj_test, POLLA_diff_test, POLLA_adpadj_skip, \
    POLLA_cheby, POLLA_softmax, POLLA_diff_embed, POLLA_diff_softmax

from util.tools import EarlyStopping, adjust_learning_rate, load_adj, count_parameters
...
class Exp_POLLA(Exp_Basic):
    ...
    def _build_model(self):
        model_dict = {
            ...
            'pollafull':POLLA_softmax,
            'pollafulldiff':POLLA_diff_softmax,
            'pollacheby':POLLA_cheby,
            'pollaembed':POLLA_diff_embed,
        }
        ...
        if self.args.model=='polladiff' or self.args.model=='pollaadp' \
            ...
            or self.args.model=='pollaadpskip' or self.args.model=='pollafulldiff':
        ...
        elif self.args.model=='pollagcn' or self.args.model=='pollafull':
        ...
        elif self.args.model=='pollacheby':
            self.support = supports
            model = model_dict[self.args.model](
                self.args.c_in, 
                self.args.c_out, 
        ...
        elif self.args.model=='pollaembed':
            self.support = supports
            model = model_dict[self.args.model](
                self.args.c_in, 
                self.args.c_out, 
    ...
    def train(self, setting):
        ...
        print('Model parameter counts: {}'.format(count_parameters(self.model)))
