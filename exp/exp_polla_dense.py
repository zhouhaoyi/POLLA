...
from models.modeldense import POLLA_diff_Score, POLLA_gcn_Score, POLLA_gcn, POLLA_diff, POLLA_adpadj
...
class Exp_POLLA(Exp_Basic):
    ...
    def _build_model(self):
        model_dict = {
            ...
            'polladiffscore': POLLA_diff_Score,
            'pollagcnscore': POLLA_gcn_Score,
        }
        ...
        elif self.args.model=='polladiffscore':
            self.support = supports
            model = model_dict[self.args.model](
                self.args.c_in, 
                self.args.c_out, 
        ...
        elif self.args.model=='pollagcnscore':
