...
from models.gcnT2S import GCN_diff, GCN
...
class STAttentionT2SLayer(nn.Module):
    def __init__(self, attention, d_model, n_heads, d_keys=None,
                 d_values=None, dropout=0.0, nodes=None):
        super(STAttentionT2SLayer, self).__init__()
